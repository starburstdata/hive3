 ...
 */
public class DecimalColEqualDecimalColumn extends VectorExpression {
  ...
  public DecimalColEqualDecimalColumn(int colNum1, int colNum2, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum1 = colNum1;
    this.colNum2 = colNum2;
  }

  public DecimalColEqualDecimalColumn() {
     super();
