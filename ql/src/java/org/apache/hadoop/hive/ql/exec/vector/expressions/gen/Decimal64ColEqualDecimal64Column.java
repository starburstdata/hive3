 ...
 */
public class Decimal64ColEqualDecimal64Column extends LongColEqualLongColumn {

  private static final long serialVersionUID = 1L;

  public Decimal64ColEqualDecimal64Column(int colNum1, int colNum2, int outputColumnNum) {
    super(colNum1, colNum2, outputColumnNum);
  }

  public Decimal64ColEqualDecimal64Column() {
    super();
  }
