...
public class VectorUDAFAvgTimestampComplete extends VectorAggregateExpression {
  ...
  public VectorUDAFAvgTimestampComplete() {
    super();
  }

  public VectorUDAFAvgTimestampComplete(VectorAggregationDesc vecAggrDesc) {
    super(vecAggrDesc);
