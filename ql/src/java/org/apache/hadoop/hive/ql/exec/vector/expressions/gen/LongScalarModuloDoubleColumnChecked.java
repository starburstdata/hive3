 ...
 */
public class LongScalarModuloDoubleColumnChecked extends VectorExpression {
  ...
  public LongScalarModuloDoubleColumnChecked(long value, int colNum, int outputColumnNum) {
    super(outputColumnNum);
    this.value = value;
    this.colNum = colNum;
  }

  public LongScalarModuloDoubleColumnChecked() {
    super();
