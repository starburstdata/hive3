 ...
 */
public class DecimalScalarEqualDecimalColumn extends VectorExpression {
  ...
  public DecimalScalarEqualDecimalColumn(HiveDecimal value, int colNum, int outputColumnNum) {
    super(outputColumnNum);
    this.value = new HiveDecimalWritable(value);
    this.colNum = colNum;
  }

  public DecimalScalarEqualDecimalColumn() {
     super();
