 ...
 */
public class DecimalColNotEqualDecimalScalar extends VectorExpression {
  ...
  public DecimalColNotEqualDecimalScalar(int colNum, HiveDecimal value, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = new HiveDecimalWritable(value);
  }

  public DecimalColNotEqualDecimalScalar() {
    super();
