 ...
 */
public class Decimal64ColGreaterDecimal64Column extends LongColGreaterLongColumn {

  private static final long serialVersionUID = 1L;

  public Decimal64ColGreaterDecimal64Column(int colNum1, int colNum2, int outputColumnNum) {
    super(colNum1, colNum2, outputColumnNum);
  }

  public Decimal64ColGreaterDecimal64Column() {
    super();
  }
