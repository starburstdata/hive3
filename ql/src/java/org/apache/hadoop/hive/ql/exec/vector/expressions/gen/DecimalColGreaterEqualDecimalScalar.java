 ...
 */
public class DecimalColGreaterEqualDecimalScalar extends VectorExpression {
  ...
  public DecimalColGreaterEqualDecimalScalar(int colNum, HiveDecimal value, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = new HiveDecimalWritable(value);
  }

  public DecimalColGreaterEqualDecimalScalar() {
    super();
  ...
  public void evaluate(VectorizedRowBatch batch) throws HiveException {
    ...
    if (inputColVector1.isRepeating) {
      if (inputColVector1.noNulls || !inputIsNull[0]) {
        ...
        outputVector[0] = vector1[0].compareTo(value) >= 0 ? 1 : 0;
      } else {
        outputIsNull[0] = true;
      ...
      if (batch.selectedInUse) {
         ...
         if (!outputColVector.noNulls) {
           for(int j = 0; j != n; j++) {
             ...
             outputVector[i] = vector1[i].compareTo(value) >= 0 ? 1 : 0;
          }
         } else {
           for(int j = 0; j != n; j++) {
             final int i = sel[j];
