...
public class VectorUDAFAvgDecimalFinal extends VectorAggregateExpression {
  ...
  public VectorUDAFAvgDecimalFinal() {
    super();
  }

  public VectorUDAFAvgDecimalFinal(VectorAggregationDesc vecAggrDesc) {
    super(vecAggrDesc);
