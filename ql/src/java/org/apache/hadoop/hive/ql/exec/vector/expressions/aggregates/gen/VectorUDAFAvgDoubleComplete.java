...
public class VectorUDAFAvgDoubleComplete extends VectorAggregateExpression {
  ...
  public VectorUDAFAvgDoubleComplete() {
    super();
  }

  public VectorUDAFAvgDoubleComplete(VectorAggregationDesc vecAggrDesc) {
    super(vecAggrDesc);
