 ...
 */
public class DecimalColEqualDecimalScalar extends VectorExpression {
  ...
  public DecimalColEqualDecimalScalar(int colNum, HiveDecimal value, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = new HiveDecimalWritable(value);
  }

  public DecimalColEqualDecimalScalar() {
    super();
