 ...
 */
public class DoubleColModuloDoubleColumnChecked extends VectorExpression {
  ...
  public DoubleColModuloDoubleColumnChecked(int colNum1, int colNum2, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum1 = colNum1;
    this.colNum2 = colNum2;
  }

  public DoubleColModuloDoubleColumnChecked() {
    super();
