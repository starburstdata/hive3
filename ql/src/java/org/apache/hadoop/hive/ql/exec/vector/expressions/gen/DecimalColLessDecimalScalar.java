 ...
 */
public class DecimalColLessDecimalScalar extends VectorExpression {
  ...
  public DecimalColLessDecimalScalar(int colNum, HiveDecimal value, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = new HiveDecimalWritable(value);
  }

  public DecimalColLessDecimalScalar() {
    super();
