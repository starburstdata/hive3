 ...
 */
public class Decimal64ColNotEqualDecimal64Column extends LongColNotEqualLongColumn {

  private static final long serialVersionUID = 1L;

  public Decimal64ColNotEqualDecimal64Column(int colNum1, int colNum2, int outputColumnNum) {
    super(colNum1, colNum2, outputColumnNum);
  }

  public Decimal64ColNotEqualDecimal64Column() {
    super();
  }
