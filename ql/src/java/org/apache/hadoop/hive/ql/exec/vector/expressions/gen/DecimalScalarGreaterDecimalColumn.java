 ...
 */
public class DecimalScalarGreaterDecimalColumn extends VectorExpression {
  ...
  public DecimalScalarGreaterDecimalColumn(HiveDecimal value, int colNum, int outputColumnNum) {
    super(outputColumnNum);
    this.value = new HiveDecimalWritable(value);
    this.colNum = colNum;
  }

  public DecimalScalarGreaterDecimalColumn() {
     super();
