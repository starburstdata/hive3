 ...
 */
public class DoubleScalarModuloLongColumnChecked extends VectorExpression {
  ...
  public DoubleScalarModuloLongColumnChecked(double value, int colNum, int outputColumnNum) {
    super(outputColumnNum);
    this.value = value;
    this.colNum = colNum;
  }

  public DoubleScalarModuloLongColumnChecked() {
    super();
