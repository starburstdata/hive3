 ...
 */
public class Decimal64ColAddDecimal64Scalar extends VectorExpression {
  ...
  public Decimal64ColAddDecimal64Scalar(int colNum, long value, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public Decimal64ColAddDecimal64Scalar() {
    super();
