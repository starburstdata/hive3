 ...
 */
public class DoubleScalarModuloDoubleColumnChecked extends VectorExpression {
  ...
  public DoubleScalarModuloDoubleColumnChecked(double value, int colNum, int outputColumnNum) {
    super(outputColumnNum);
    this.value = value;
    this.colNum = colNum;
  }

  public DoubleScalarModuloDoubleColumnChecked() {
    super();
