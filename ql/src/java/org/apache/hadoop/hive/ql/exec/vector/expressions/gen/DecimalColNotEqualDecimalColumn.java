 ...
 */
public class DecimalColNotEqualDecimalColumn extends VectorExpression {
  ...
  public DecimalColNotEqualDecimalColumn(int colNum1, int colNum2, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum1 = colNum1;
    this.colNum2 = colNum2;
  }

  public DecimalColNotEqualDecimalColumn() {
     super();
