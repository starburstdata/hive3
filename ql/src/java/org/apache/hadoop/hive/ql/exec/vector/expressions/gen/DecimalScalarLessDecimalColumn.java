 ...
 */
public class DecimalScalarLessDecimalColumn extends VectorExpression {
  ...
  public DecimalScalarLessDecimalColumn(HiveDecimal value, int colNum, int outputColumnNum) {
    super(outputColumnNum);
    this.value = new HiveDecimalWritable(value);
    this.colNum = colNum;
  }

  public DecimalScalarLessDecimalColumn() {
     super();
