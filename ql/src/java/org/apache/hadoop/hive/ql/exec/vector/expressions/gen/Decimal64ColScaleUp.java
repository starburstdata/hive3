...
import org.apache.hadoop.hive.ql.exec.vector.expressions.gen.Decimal64ColMultiplyDecimal64Scalar;
 ...
 */
public class Decimal64ColScaleUp extends Decimal64ColMultiplyDecimal64Scalar {

  public Decimal64ColScaleUp(int colNum, long value, int outputColumnNum) {
    super(colNum, value, outputColumnNum);
  }

  public Decimal64ColScaleUp() {
    super();
  }
