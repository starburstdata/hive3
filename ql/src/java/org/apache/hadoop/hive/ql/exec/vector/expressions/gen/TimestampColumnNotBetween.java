 ...
 */
public class TimestampColumnNotBetween extends VectorExpression {
  ...
  public TimestampColumnNotBetween() {
    super();
   ...
   */
  public TimestampColumnNotBetween(int colNum, Timestamp leftValue, Timestamp rightValue, int outputColumnNum) {
  ...
  public void evaluate(VectorizedRowBatch batch) throws HiveException {
    ...
    if (inputColVector.isRepeating) {
      if (inputColVector.noNulls || !inputIsNull[0]) {
        ...
        outputVector[0] =
           !(inputColVector.compareTo(0, leftValue) < 0 ||
      ...
      if (batch.selectedInUse) {
        ...
        if (!outputColVector.noNulls) {
          for(int j = 0; j != n; j++) {
           ...
           outputVector[i] =
               !(inputColVector.compareTo(i, leftValue) < 0 ||
