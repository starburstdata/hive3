...
public class VectorUDAFAvgLongComplete extends VectorAggregateExpression {
  ...
  public VectorUDAFAvgLongComplete() {
    super();
  }

  public VectorUDAFAvgLongComplete(VectorAggregationDesc vecAggrDesc) {
    super(vecAggrDesc);
