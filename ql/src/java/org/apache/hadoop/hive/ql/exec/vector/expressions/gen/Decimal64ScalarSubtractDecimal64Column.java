 ...
 */
public class Decimal64ScalarSubtractDecimal64Column extends VectorExpression {
  ...
  public Decimal64ScalarSubtractDecimal64Column(long value, int colNum, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public Decimal64ScalarSubtractDecimal64Column() {
    super();
