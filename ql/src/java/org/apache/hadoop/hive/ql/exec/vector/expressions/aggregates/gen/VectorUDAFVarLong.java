...
/**
* VectorUDAFVarLong. Vectorized implementation for VARIANCE aggregates.
*/
...
public class VectorUDAFVarLong extends VectorAggregateExpression {
  ...
  public VectorUDAFVarLong() {
    super();
  }

  public VectorUDAFVarLong(VectorAggregationDesc vecAggrDesc) {
    super(vecAggrDesc);
