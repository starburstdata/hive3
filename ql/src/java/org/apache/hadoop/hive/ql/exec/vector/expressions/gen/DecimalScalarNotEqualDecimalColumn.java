 ...
 */
public class DecimalScalarNotEqualDecimalColumn extends VectorExpression {
  ...
  public DecimalScalarNotEqualDecimalColumn(HiveDecimal value, int colNum, int outputColumnNum) {
    super(outputColumnNum);
    this.value = new HiveDecimalWritable(value);
    this.colNum = colNum;
  }

  public DecimalScalarNotEqualDecimalColumn() {
     super();
