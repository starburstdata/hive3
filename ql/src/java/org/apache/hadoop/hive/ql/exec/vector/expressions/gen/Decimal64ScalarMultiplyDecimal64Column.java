 ...
 */
public class Decimal64ScalarMultiplyDecimal64Column extends VectorExpression {
  ...
  public Decimal64ScalarMultiplyDecimal64Column(long value, int colNum, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public Decimal64ScalarMultiplyDecimal64Column() {
    super();
