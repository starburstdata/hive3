 ...
 */
public class DecimalColGreaterDecimalColumn extends VectorExpression {
  ...
  public DecimalColGreaterDecimalColumn(int colNum1, int colNum2, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum1 = colNum1;
    this.colNum2 = colNum2;
  }

  public DecimalColGreaterDecimalColumn() {
     super();
