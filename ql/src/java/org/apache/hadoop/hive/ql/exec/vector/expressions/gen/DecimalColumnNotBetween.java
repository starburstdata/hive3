 ...
 */
public class DecimalColumnNotBetween extends VectorExpression {
   ...
   */
  public DecimalColumnNotBetween(int colNum, HiveDecimal leftValue, HiveDecimal rightValue,
      int outputColumnNum) {
  ...
  public void evaluate(VectorizedRowBatch batch) throws HiveException {
    ...
    if (inputColumnVector.isRepeating) {
      if (inputColumnVector.noNulls || !inputIsNull[0]) {
        ...
        outputVector[0] =
            !(DecimalUtil.compare(repeatValue, leftValue) < 0 ||
      ...
      if (batch.selectedInUse) {
        ...
        if (!outputColVector.noNulls) {
          for(int j = 0; j != n; j++) {
           ...
           outputVector[i] =
               !(DecimalUtil.compare(value, leftValue) < 0 ||
