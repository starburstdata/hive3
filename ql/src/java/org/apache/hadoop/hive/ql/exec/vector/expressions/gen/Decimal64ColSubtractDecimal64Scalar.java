 ...
 */
public class Decimal64ColSubtractDecimal64Scalar extends VectorExpression {
  ...
  public Decimal64ColSubtractDecimal64Scalar(int colNum, long value, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = value;
  }

  public Decimal64ColSubtractDecimal64Scalar() {
    super();
  ...
  public void evaluate(VectorizedRowBatch batch) throws HiveException {
    ...
    if (inputColVector.isRepeating) {
      if (inputColVector.noNulls || !inputIsNull[0]) {
        ...
        final long result = vector[0] - value;
      ...
      if (batch.selectedInUse) {
         ...
         if (!outputColVector.noNulls) {
           for(int j = 0; j != n; j++) {
            ...
            final long result = vector[i] - value;
