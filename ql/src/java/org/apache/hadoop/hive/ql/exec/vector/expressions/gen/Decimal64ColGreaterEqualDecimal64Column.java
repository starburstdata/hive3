 ...
 */
public class Decimal64ColGreaterEqualDecimal64Column extends LongColGreaterEqualLongColumn {

  private static final long serialVersionUID = 1L;

  public Decimal64ColGreaterEqualDecimal64Column(int colNum1, int colNum2, int outputColumnNum) {
    super(colNum1, colNum2, outputColumnNum);
  }

  public Decimal64ColGreaterEqualDecimal64Column() {
    super();
  }
