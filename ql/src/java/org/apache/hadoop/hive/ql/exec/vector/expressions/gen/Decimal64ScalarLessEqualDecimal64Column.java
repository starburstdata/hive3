 ...
 * in-place filtering.
 */
public class Decimal64ScalarLessEqualDecimal64Column extends LongScalarLessEqualLongColumn {

  private static final long serialVersionUID = 1L;

  public Decimal64ScalarLessEqualDecimal64Column(long value, int colNum, int outputColumnNum) {
    super(value, colNum, outputColumnNum);
  }

  public Decimal64ScalarLessEqualDecimal64Column() {
    super();
  }
