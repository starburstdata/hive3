 ...
 */
public class IfExprDecimalColumnColumn extends VectorExpression {
  ...
  public IfExprDecimalColumnColumn(int arg1Column, int arg2Column, int arg3Column,
      int outputColumnNum) {
  ...
  public IfExprDecimalColumnColumn() {
    super();
