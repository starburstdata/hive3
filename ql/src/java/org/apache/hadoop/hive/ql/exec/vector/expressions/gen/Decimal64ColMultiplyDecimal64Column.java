 ...
 */
public class Decimal64ColMultiplyDecimal64Column extends VectorExpression {
  ...
  public Decimal64ColMultiplyDecimal64Column(int colNum1, int colNum2, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum1 = colNum1;
    this.colNum2 = colNum2;
  }

  public Decimal64ColMultiplyDecimal64Column() {
    super();
