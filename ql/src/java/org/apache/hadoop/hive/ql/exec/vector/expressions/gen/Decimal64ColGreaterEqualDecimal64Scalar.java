 ...
 * in-place filtering.
 */
public class Decimal64ColGreaterEqualDecimal64Scalar extends LongColGreaterEqualLongScalar {

  private static final long serialVersionUID = 1L;

  public Decimal64ColGreaterEqualDecimal64Scalar(int colNum, long value, int outputColumnNum) {
    super(colNum, value, outputColumnNum);
  }

  public Decimal64ColGreaterEqualDecimal64Scalar() {
    super();
  }
