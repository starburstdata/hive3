...
/**
* VectorUDAFVarLongComplete. Vectorized implementation for VARIANCE aggregates.
*/
@Description(name = "variance, var_pop, var_samp, std, stddev, stddev_pop, stddev_samp",
    value = "_FUNC_(x) - Returns one of the variance family of a set of numbers (vectorized, long)")
public class VectorUDAFVarLongComplete extends VectorAggregateExpression {
  ...
  public VectorUDAFVarLongComplete() {
    super();
  }

  public VectorUDAFVarLongComplete(VectorAggregationDesc vecAggrDesc) {
    super(vecAggrDesc);
