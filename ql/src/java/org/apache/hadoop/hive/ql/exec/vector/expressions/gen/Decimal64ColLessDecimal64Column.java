 ...
 */
public class Decimal64ColLessDecimal64Column extends LongColLessLongColumn {

  private static final long serialVersionUID = 1L;

  public Decimal64ColLessDecimal64Column(int colNum1, int colNum2, int outputColumnNum) {
    super(colNum1, colNum2, outputColumnNum);
  }

  public Decimal64ColLessDecimal64Column() {
    super();
  }
