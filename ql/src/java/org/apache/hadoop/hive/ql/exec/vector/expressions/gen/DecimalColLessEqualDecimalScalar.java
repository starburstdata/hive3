 ...
 */
public class DecimalColLessEqualDecimalScalar extends VectorExpression {
  ...
  public DecimalColLessEqualDecimalScalar(int colNum, HiveDecimal value, int outputColumnNum) {
    super(outputColumnNum);
    this.colNum = colNum;
    this.value = new HiveDecimalWritable(value);
  }

  public DecimalColLessEqualDecimalScalar() {
    super();
