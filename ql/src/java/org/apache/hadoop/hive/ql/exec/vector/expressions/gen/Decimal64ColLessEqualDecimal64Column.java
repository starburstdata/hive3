 ...
 */
public class Decimal64ColLessEqualDecimal64Column extends LongColLessEqualLongColumn {

  private static final long serialVersionUID = 1L;

  public Decimal64ColLessEqualDecimal64Column(int colNum1, int colNum2, int outputColumnNum) {
    super(colNum1, colNum2, outputColumnNum);
  }

  public Decimal64ColLessEqualDecimal64Column() {
    super();
  }
