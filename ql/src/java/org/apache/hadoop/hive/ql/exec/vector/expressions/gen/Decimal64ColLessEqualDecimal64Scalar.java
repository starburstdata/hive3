 ...
 * in-place filtering.
 */
public class Decimal64ColLessEqualDecimal64Scalar extends LongColLessEqualLongScalar {

  private static final long serialVersionUID = 1L;

  public Decimal64ColLessEqualDecimal64Scalar(int colNum, long value, int outputColumnNum) {
    super(colNum, value, outputColumnNum);
  }

  public Decimal64ColLessEqualDecimal64Scalar() {
    super();
  }
